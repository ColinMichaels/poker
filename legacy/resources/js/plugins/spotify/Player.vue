<template>
    <div class="flex items-center justify-center">
        <div class="bg-white shadow-lg rounded-lg flex-grow">
            <div class="flex">
                <div>
                ...
                <div class="w-full p-8">
                    <div class="flex justify-between">
                        <div>
                            <h3 class="text-2xl text-gray-1000 font-medium">{{track.title}}</h3>
                            <p class="text-sm text-gray mt-1">{{track.artist}}</p>
                        </div>
            ...
            <div class="mx-8 py-4">
                <div class="flex justify-between text-sm text-gray-darker">
                    <p>{{track.time.elapsed}}</p>
                    <p>{{track.time.total}}</p>
                </div>
                <div class="mt-1">
                    <div class="h-1 bg-gray-dark rounded-full">
