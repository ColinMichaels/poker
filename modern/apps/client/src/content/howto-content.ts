...
export const HOW_TO_GUIDES: HowToGuide[] = [
  {
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/TexasHoldem.vue"
  },
  {
    "id": "seven-card-stud-high-low",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/SevenCardStudHighLow.vue"
  },
  {
    "id": "seven-card-stud",
    ...
    "rules": [
      ...
      "A player who calls a bet even though beaten by an opponents upcards is not entitled to a refund. (The player is receiving information about an opponent's hand that is not available for free.)"
    ],
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/SevenCardStud.vue"
  },
  {
    "id": "omaha",
    "name": "Omaha",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/Omaha.vue"
  },
  {
    "id": "lowball",
    "name": "Lowball",
    ...
    "rules": [
      ...
      "In limit play, a bet and four raises are allowed in multihanded pots. See Explanations, discussion #6 , for more information on this rule.",
      ...
      "In limit ace-to-five lowball, before the draw, an exposed card of 7 or under must be taken, and an exposed card higher than a 7 must be replaced after the deal has been completed. This first exposed card is used as the burn card. See Explanations, discussion #8 , for more information on this rule.",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/Lowball.vue"
  },
  {
    "id": "mississippi-stud",
    ...
    "rules": [],
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/MississippiStud.vue"
  },
  {
    "id": "razz",
    "name": "Razz",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/Razz.vue"
  },
  {
    "id": "jacks-or-better",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/JacksOrBetter.vue"
  },
  {
    "id": "draw-high",
    "name": "Draw High",
    ...
    "sourceFile": "legacy/resources/js/Pages/HowTo/games/DrawHigh.vue"
  }
];
